...
const Signin = () => {
  return (
    <div class=" bg-transparent border-2  mt-[2rem] border-white text-white w-[30vw] rounded-lg p-8 flex flex-col">
      ...
      <p class="text-lg w-full flex justify-between px-2 mt-3">
        Alread regestered{" "}
        <button className="text-blue-500 hover:text-blue-900">Signup</button>
      </p>
    </div>
  );
};
