...
const Home = () => {
  return (
    <div class="bg-white">
      ...
      <section class="bg-[#FCF8F1] relative bg-opacity-30 py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <h1 class="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl capitalize xl:text-8xl">
                Food from Best chefs from World
              </h1>
              <p class="mt-4 text-base text-black lg:mt-8 sm:text-xl">
                Grow your Taste fast with right Food.
              </p>

              <a
                href="#"
                title=""
                class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-black transition-all duration-200 bg-yellow-300 rounded-full capitalize lg:mt-16 hover:bg-yellow-400 focus:bg-yellow-400"
                role="button"
              >
                get Started
                <svg
        ...
        <div className="line w-[90%] mt-6 ml-12 h-[2px] bg-black  bottom-10 mb-3"></div>
        <Blogitem />
      </section>
      <Footer />
    </div>
